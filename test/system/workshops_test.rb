...
class WorkshopsTest < ApplicationSystemTestCase
  ...
  test "creating a Workshop" do
    ...
    fill_in "Deadline", with: @workshop.deadline
    fill_in "Name", with: @workshop.name
    fill_in "Number", with: @workshop.number
    fill_in "Question", with: @workshop.question_id
    fill_in "Score", with: @workshop.score
    fill_in "Student", with: @workshop.student_id
    fill_in "Subject", with: @workshop.subject_id
